...
class RepositoryEloquentMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $description = 'Create a new repostory eloquent file';
    ...
    public function handle()
    {
        ...
        $this->input->setArgument('name', $this->model . "EloquentRepository");
    ...
    {
        return  base_path('stubs/Repository/EloquentRepository.stub');
    }
    /**
    ...
    {
        return  $rootNamespace . '\Repository\Eloquent\\'. $this->path;
    }
